...
export const NOBLES: NobleDef[] = [
  ...
  { id: 'lutnick', name: 'Tariff Tsar', realName: 'Howard Lutnick', suit: 'executive', points: 3, ability: 'none', blurb: '' },
  { id: 'bondi', name: 'Briefcase', realName: 'Pam Bondi', suit: 'executive', points: 2, ability: 'draw_action', blurb: 'Draw an extra action card after you collect this.' },
  { id: 'patel', name: 'Loyalty File', realName: 'Kash Patel', suit: 'executive', points: 2, ability: 'draw_action', blurb: 'Draw an extra action card after you collect this.' },
  ...
  { id: 'mccarthy', name: 'Gavel Ghost', realName: 'Kevin McCarthy', suit: 'legislative', points: 3, ability: 'none', blurb: '' },
  ...
  { id: 'schumer', name: 'Israel Firster', realName: 'Chuck Schumer', suit: 'legislative', points: 2, ability: 'none', blurb: '' },

  // ——— Judicial (classic green) ———
  { id: 'roberts', name: 'Tax Dodge', realName: 'John Roberts', suit: 'judicial', points: 4, ability: 'none', blurb: '' },
  { id: 'alito', name: 'Flag Neighbor', realName: 'Samuel Alito', suit: 'judicial', points: 3, ability: 'none', blurb: '' },
  { id: 'thomas', name: 'RV Recusal', realName: 'Clarence Thomas', suit: 'judicial', points: 3, ability: 'none', blurb: '' },
  ...
  { id: 'tucker', name: 'Chin Desk', realName: 'Tucker Carlson', suit: 'media', points: 4, ability: 'none', blurb: '' },
  { id: 'alex_jones', name: 'Frog Boiler', realName: 'Alex Jones', suit: 'media', points: 3, ability: 'none', blurb: '' },
  { id: 'hannity', name: 'Primetime Bark', realName: 'Sean Hannity', suit: 'media', points: 2, ability: 'none', blurb: '' },
  { id: 'rogan', name: 'Three-Hour Guest', realName: 'Joe Rogan', suit: 'media', points: 2, ability: 'none', blurb: '' },
  { id: 'fuentes', name: 'Groyper', realName: 'Nick Fuentes', suit: 'media', points: 1, ability: 'none', blurb: '' },
  { id: 'okeefe', name: 'Sting Boy', realName: "James O'Keefe", suit: 'media', points: 1, ability: 'none', blurb: '' },
